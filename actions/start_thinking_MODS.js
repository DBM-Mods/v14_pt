module.exports = {
  ...
  meta: {
    ...
    authorUrl: 'https://github.com/DBM-Mods/v14_pt',
    downloadURL: 'https://github.com/DBM-Mods/v14_pt/archive/refs/heads/main.zip',
  },
...
.dbmmodsbr2{position:absolute;bottom:0px;border: 0px solid rgba(50,50,50,0.7);background:rgba(0,0,0,0.7);color:#999;padding:5px;right:0px;z-index:999999;cursor:pointer}
  ...
  action(cache) {
    ...
    if (data.cx == "0") {
      ...
      if(data.ephemeral == true) { options.flags = MessageFlags.Ephemeral }



    } else {
      efemeralxin = this.evalMessage(data.ephemeralsub, cache);
      if (efemeralxin == "true") { options.flags = MessageFlags.Ephemeral }
    }
